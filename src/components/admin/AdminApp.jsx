  ...
  const mainContent = (
    <div className="flex-1 min-w-0 flex flex-col">
      ...
      <main className="flex-1 overflow-y-auto px-4 py-5 pb-24" style={{ paddingLeft: isMobile ? 16 : 30, paddingRight: isMobile ? 16 : 30, paddingTop: isMobile ? 16 : 28 }}>
        <div className={selectedOrder ? 'max-w-[1400px] mx-auto' : 'max-w-[1180px] mx-auto'}>
          {selectedOrder ? (
            <AdminOrderPage
              order={selectedOrder}
        ...
        <div className="safe-top" style={{ background: 'var(--pp-nav)' }}>
          <div className="px-4 py-3 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] font-bold uppercase mt-0.5" style={{ color: 'var(--pp-text4)', letterSpacing: '.04em' }}>Admin · v{APP_VERSION}</div>
            </div>
